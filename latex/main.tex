...
\begin{document}
    ...
    \include{./02-elementos-textuais/arte-computacional}           % Disposições
    \include{./02-elementos-textuais/interacao-e-participacao}  			% Estrutura    
    \include{./02-elementos-textuais/luz-material}           	% Ilustrações
    \include{./02-elementos-textuais/composicao}            	% Citações
    \include{./02-elementos-textuais/consideracoes-finais}            % Tecnica de referencias 
