...
\usepackage[alf, abnt-emphasize=bf, recuo=0cm, abnt-etal-cite=2, abnt-etal-list=0, abnt-full-initials=yes, abnt-repeated-author-omit=yes]{abntex2cite} % Citações padrão ABNT
...
\usepackage{float} % Utilizado para criação d\input{diretrizes.cls}e floats
...
\hypersetup{
    ...
    pdfkeywords={art, kinect, arduino, art and technology}
}
\makeatother
...
\begin{document}
    ...
    % \includepdf{./01-elementos-pre-textuais/fichaCatalografica.pdf}
    ...
    \include{./02-elementos-textuais/arte-computacional} 
    \include{./02-elementos-textuais/luz-material} 
    \include{./02-elementos-textuais/composicao}    
    \include{./02-elementos-textuais/projetos-futuros}
    \include{./02-elementos-textuais/consideracoes-finais}
