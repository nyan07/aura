...
\usepackage[alf, abnt-emphasize=bf, recuo=0cm, abnt-etal-cite=2, abnt-etal-list=0,,abnt-full-initials=yes]{abntex2cite} % Citações padrão ABNT
...
\begin{document}
    ...
    \include{./02-elementos-textuais/interacao-e-participacao} 
