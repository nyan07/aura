...
Cabe destacar que existem diferentes níveis de interatividade. \citeonline[p. 14]{bochio} elucida que, determinar os graus de interatividade, significa identificar os modos e as possibilidades de interação em função da maneira como se manifesta o diálogo entre homem e máquina, que, por sua vez, somente é estabelecido através das especificidades dos dispositivos informacionais e comunicacionais. Para \citeonline[p. 82]{levy} uma mídia ou dispositivo de comunicação possui diferentes graus de interatividade e eles podem ser medido em eixos distintos, dos quais destaca os seguintes
