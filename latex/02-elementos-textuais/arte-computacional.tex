...
\citeonline{primo} sugere que há dois tipos de interação: mútua e reativa. E as analisa em sete dimensões, são elas: sistema, um conjunto de objetos ou entidades que se inter-relacionam entre si formando um todo; processo, acontecimentos que apresentam mudanças no tempo; operação, a produção de um trabalho ou a relação entre a ação e a
...
em um sistema informático reativo,
